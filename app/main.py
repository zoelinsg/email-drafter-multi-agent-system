...
async def chat_stream(request: SimpleChatRequest):
    """Streaming chat endpoint for the Email Drafter app."""
    ...
    async def event_generator():
        ...
        async for event in events:
            ...
            if author == "researcher":
                yield json.dumps({
                    "type": "progress",
                    "text": "🧭 Topic Agent is planning the email..."
                }) + "\n"

            elif author == "judge":
                yield json.dumps({
                    "type": "progress",
                    "text": "🧐 Reviewer Agent is checking the email plan..."
                }) + "\n"

            elif author == "content_builder":
                yield json.dumps({
                    "type": "progress",
                    "text": "✍️ Writer Agent is drafting the email..."
                }) + "\n"
